...
public class Test {
    ...
    public void test() throws GeneralSecurityException, MessagingException {
        ...
        //DataHandler数据处理
        DataHandler dh = new DataHandler(new FileDataSource("F:\\Java\\Java_Study\\Jav_Web\\web-file-upload\\src\\main\\resources\\bz.png"));
        image.setDataHandler(dh); //在我们的body中放入这个图片的数据
