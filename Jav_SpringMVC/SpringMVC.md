...
2、提交数据 : http://localhost:8080/mvc04/user?name=fransshen&id=1&age=15
...
<configuration>
   ...
   <mappers>
       <mapper resource="com/frans/dao/BookMapper.xml"/>
   </mappers>

</configuration>
```

4、编写数据库对应的实体类 com.frans.pojo.Books
...
<mapper namespace="com.frans.dao.BookMapper">
...
import com.frans.dao.BookMapper;
import com.frans.pojo.Books;
import java.util.List;
...
<beans xmlns="http://www.springframework.org/schema/beans"
   ...
   <bean class="org.mybatis.spring.mapper.MapperScannerConfigurer">
       ...
       <!-- 给出需要扫描Dao接口包 -->
       <property name="basePackage" value="com.frans.dao"/>
   </bean>
...
<beans xmlns="http://www.springframework.org/schema/beans"
   ...
   <bean id="BookServiceImpl" class="com.frans.service.BookServiceImpl">
...
<mvc:interceptors>
   <mvc:interceptor>
       ...
       <mvc:mapping path="/**"/>
       <!--bean配置的就是拦截器-->
       <bean class="com.frans.interceptor.MyInterceptor"/>
   </mvc:interceptor>
</mvc:interceptors>
```
...
<mvc:interceptors>
   <mvc:interceptor>
       <mvc:mapping path="/**"/>
       <bean id="loginInterceptor" class="com.frans.interceptor.LoginInterceptor"/>
   </mvc:interceptor>
</mvc:interceptors>
```
