		...
		<div class="outer">
			...
			<div class="down_wrap">
				<div class="down_inner">
					<h1>新增员工信息</h1>
					<form method="post"
						action="<%=request.getContextPath()%>/servlet/InsertStaffServlet">
						<div class="inner_list">
							<span>编号：</span><input type="number" name="id" class="inner_inp"
								οnkeyup="if(/\D/.test(this.value)){alert('只能输入数字');this.value='';}">
						</div>
						<div class="inner_list">
							<span>姓名：</span><input type="text" name="name" class="inner_inp"
						...
						<div class="inner_list">
							<span>民族：</span> <select name="nation" class="inner_inp selet"
								id="nation">
								<option disabled="disabled" selected="selected">请选择民族</option>
								<option>汉族</option>
								<option>满族</option>
								<option>蒙古族</option>
								<option>回族</option>
						...
						<div class="inner_list">
							<span>手机号：</span><input type="number" name="phone"
								class="inner_inp"
								οnkeyup="if(/\D/.test(this.value)){alert('只能输入数字');this.value='';}">
						</div>
						<div class="inner_list">
							<span>身份证号：</span><input type="number" name="idcard"
								class="inner_inp"
								οnkeyup="if(/\D/.test(this.value)){alert('只能输入数字');this.value='';}">
						</div>
						<div class="inner_list">
						...
						<div class="inner_list">
							<span>职 位：</span> <select name="profe" class="inner_inp selet"
								id="profe">
								<option disabled="disabled" selected="selected">请选择职位</option>
								<option>普通职员</option>
								<option>主管</option>
							</select>
						</div>
						<div class="inner_list">
							<span>邮 箱：</span><input type="text" name="email"
								class="inner_inp" id="email">
						</div>
						<div class="inner_list">
							<span>入职日期：</span><input type="text" name="entry"
								class="inner_inp" onkeyup="value=value.replace(/[^\d.]/g,'')"
								placeholder="输入格式为2020.01.01">
						</div>
						<div class="inner_list">
							<span>毕业学校：</span><input type="text" name="school"
								class="inner_inp" id="school"
								onkeyup="value=value.replace(/[^\u4E00-\u9FA5]/g,'')"
								onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\u4E00-\u9FA5]/g,''))">
						</div>
						<div class="inner_list">
							<span>学 历：</span> <select name="educat" class="inner_inp selet"
								id="educat">
								<option disabled="disabled" selected="selected">请选择学历</option>
								<option>本科</option>
								<option>硕士</option>
								<option>博士</option>
								<option>大专</option>
						...
						<div class="inner_list">
							<span>出生日期：</span><input type="text" name="birth"
								class="inner_inp" onkeyup="value=value.replace(/[^\d.]/g,'')"
								placeholder="输入格式为2020.01.01">
						</div>

						<input class="inner_btn btn1" type="submit" value="保存信息">
						<input class="inner_btn btn2" type="button" value="取消保存"
